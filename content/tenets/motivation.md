...
The emergence of cryptographic implements, such as [PGP](https://en.wikipedia.org/wiki/Pretty_Good_Privacy) and [Bitcoin](https://en.bitcoin.it/wiki/Main_Page), have created a new paradigm, enabling the minimization of resource intensive externalities and allowing individuals leading open source projects to focus on code quality.
